  ...
  const getCuratorMessage = () => {
    ...
    switch (aiStatus) {
      ...
      default:
        ...
        return ticketInfo?.curatorMessage || '안녕하세요! 당신을 위한 영화를 추천해드릴게요. 안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.안녕하세요! 당신을 위한 영화를 추천해드릴게요.';
    }
  };
